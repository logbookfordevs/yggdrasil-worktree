          ...
          <article className="min-w-0 max-w-4xl">
            ...
            <section id="configuration" className="border-t border-gold-rune/15 py-10 sm:py-14">
              ...
              <div className="mt-6 grid gap-5">
                <div className="min-w-0 rounded-lg border border-gold-rune/20 bg-mist-green/25 p-4 sm:p-6">
    ...
    "git submodule update --init --recursive"
            ...
            <section id="safety" className="border-t border-gold-rune/15 py-10 sm:py-14">
              ...
              <div className="mt-6 grid gap-4">
                ...
                <p className={`rounded-lg border border-gold-rune/15 bg-mist-green/20 p-5 ${bodyPanelClass}`}>
                  Use `delete --all` carefully. It can include linked worktrees outside the configured managed root,
                  while still protecting the main and current worktree.
                </p>
              </div>
            </section>
